...
class EatDemonPacGift :public Gift
{
public:
	EatDemonPacGift(const enum Pictures& p, sf::Vector2f position);
	virtual~EatDemonPacGift()=default;
	EatDemonPacGift(const EatDemonPacGift& other) = default;
